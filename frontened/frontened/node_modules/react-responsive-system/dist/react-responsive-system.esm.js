import { createContext, useState, useLayoutEffect, createElement, useContext, forwardRef } from 'react';
...
function createResponsiveSystem(screenClassConfiguration) {
  ...
  var screenClassContext = createContext(undefined); //
  // ─── PROVIDER ───────────────────────────────────────────────────────────────────
  //
  ...
  var ScreenClassProvider = function ScreenClassProvider(_ref4) {
    ...
    var _React$useState = useState(defaultScreenClass),
  ...
  function useScreenClass() {
    var screenClass = useContext(screenClassContext);
  ...
  function useResponsiveProps(props) {
    var currentScreenClass = useContext(screenClassContext);
    ...
    if (currentScreenClass === undefined) {
      ...
      return omit(props, sortedScreenClasses);
    } //
    // ─── DETERMINE PROPS ─────────────────────────────────────────────
    //
    // TypeScript: this is correct, but TS is having trouble confirming that it will be type P
  ...
  function responsive(Component) {
    // @ts-ignore
    var ResponsiveComponent = forwardRef(function (props, ref) {
...
export { createResponsiveSystem };
//# sourceMappingURL=react-responsive-system.esm.js.map
